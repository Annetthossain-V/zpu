    ...
    pub fn tokenize(&mut self) {
        for i in 0..self.split_word.len() { 
            match self.split_word[i].as_str() {
                ...
                "call" => self.tokens.push(Token::Key(Keys::Call)),
                "jmp" => self.tokens.push(Token::Key(Keys::Jmp)),
                "jne" => self.tokens.push(Token::Key(Keys::Jne)),
                "je" => self.tokens.push(Token::Key(Keys::Je)),
                "jg" => self.tokens.push(Token::Key(Keys::Jg)),
                "jge" => self.tokens.push(Token::Key(Keys::Jge)),
                "jng" => self.tokens.push(Token::Key(Keys::Jng)),
                "jnge" => self.tokens.push(Token::Key(Keys::Jnge)),
                "cmp" => self.tokens.push(Token::Key(Keys::Cmp)),
                "ptr" => self.tokens.push(Token::Key(Keys::Ptr)),
                "uptr" => self.tokens.push(Token::Key(Keys::UPtr)),
